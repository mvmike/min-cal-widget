...
internal class ThemeTest: BaseTest() {
    ...
    private fun getCombinationOfThemesAndDaysOfWeek(): Stream<Arguments> = Stream.of(
        ...
        Arguments.of(
            ...
            Cell(id = cellViewId, layout = 2131427366, background = 2131034148)
        ),
        Arguments.of(
            Theme.DARK, DayOfWeek.SUNDAY,
            Cell(id = cellViewId, layout = 2131427367, background = 2131034152)
        ),
        Arguments.of(
            Theme.LIGHT, DayOfWeek.MONDAY,
            Cell(id = cellViewId, layout = 2131427375, background = null)
        ),
        Arguments.of(
        ...
        Arguments.of(
            ...
            Cell(id = cellViewId, layout = 2131427376, background = 2131034149)
        ),
        Arguments.of(
            Theme.LIGHT, DayOfWeek.SUNDAY,
            Cell(id = cellViewId, layout = 2131427377, background = 2131034153)
        )
    )
    ...
    private fun getCombinationOfThemesAndDayStatuses(): Stream<Arguments> = Stream.of(
        Arguments.of(
            ...
            Cell(id = cellViewId, layout = 2131427364, background = 2131034158)
        ),
        Arguments.of(
        ...
        Arguments.of(
            ...
            Cell(id = cellViewId, layout = 2131427362, background = 2131034154)
        ),
        Arguments.of(
            Theme.DARK, false, true, DayOfWeek.MONDAY,
            Cell(id = cellViewId, layout = 2131427363, background = 2131034156)
        ),
        Arguments.of(
        ...
        Arguments.of(
            ...
            Cell(id = cellViewId, layout = 2131427374, background = 2131034159)
        ),
        Arguments.of(
        ...
        Arguments.of(
            ...
            Cell(id = cellViewId, layout = 2131427370, background = 2131034151)
        ),
        Arguments.of(
            Theme.LIGHT, true, true, DayOfWeek.SUNDAY,
            Cell(id = cellViewId, layout = 2131427372, background = 2131034155)
        ),
        Arguments.of(
            Theme.LIGHT, false, true, DayOfWeek.MONDAY,
            Cell(id = cellViewId, layout = 2131427373, background = 2131034157)
        ),
        Arguments.of(
        ...
        Arguments.of(
            ...
            Cell(id = cellViewId, layout = 2131427369, background = 2131034149)
        ),
        Arguments.of(
            Theme.LIGHT, false, true, DayOfWeek.SUNDAY,
            Cell(id = cellViewId, layout = 2131427371, background = 2131034153)
        ),
        Arguments.of(
            Theme.LIGHT, false, false, DayOfWeek.MONDAY,
            Cell(id = cellViewId, layout = 2131427368, background = null)
        ),
        Arguments.of(
